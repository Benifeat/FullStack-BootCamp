...
const yesterday = new Date('2024-04-28');
...
student1.getInitials = function() {
    const [firstInitial, lastInitial] = [this.firstName[0], this.lastName[0]];
    this.initials = `${firstInitial.toUpperCase()}.${lastInitial.toUpperCase()}.`;
    console.log(this.initials);
};

student2.getInitials = function() {
    const [firstInitial, lastInitial] = [this.firstName[0], this.lastName[0]];
    this.initials = `${firstInitial.toUpperCase()}.${lastInitial.toUpperCase()}.`;
    console.log(this.initials);
};

student1.getInitials(); // Output: J.D.
student2.getInitials(); // Output: T.C.

// b filtering the j's
const students = [student1, student2, student3, student4];
const jStudents = students.filter(student => student.firstName[0].toLowerCase() === 'j');
console.log(jStudents); 

// c 
console.log(student4['grades']);


// d array of last names 

let someOtherProperty = 'lastName';
const lastNames = students.map(student => student[someOtherProperty]);
console.log(lastNames);


// e jennifer lopez age 
student4.birthDate = '1997-08-11';
student4.calcAge = function() {
